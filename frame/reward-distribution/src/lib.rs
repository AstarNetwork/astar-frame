...
//! impl TvlProvider<Balance> for TvlProvider {
//!     fn tvl() -> Balance {
...
pub mod pallet {
    ...
    pub trait Config: frame_system::Config {
        ...
        type DappsStakingTvlProvider: TvlProvider<BalanceOf<Self>>;
    ...
    impl<T: Config> Pallet<T> {
        ...
        fn tvl_percentage() -> Perbill {
            ...
            if total_issuance.is_zero() {
                ...
                Perbill::from_rational(T::DappsStakingTvlProvider::tvl(), total_issuance)
            }
        }
    }
}
...
/// Provides total value locked function
pub trait TvlProvider<Balance> {
    /// Total value locked as amount
    fn tvl() -> Balance;
}
